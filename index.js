...
(function($PS) {
  "use strict";
  $PS["OutilsJeu"] = $PS["OutilsJeu"] || {};
  var exports = $PS["OutilsJeu"];
  var Data_Eq = $PS["Data.Eq"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Ord = $PS["Data.Ord"];
  var Data_Ordering = $PS["Data.Ordering"];
 ...
 */  
  ...
  var showPoke = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at OutilsJeu (line 48, column 1 - line 51, column 24): " + [ v.constructor.name ]);
  });
  var showPFCLS = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at OutilsJeu (line 40, column 1 - line 45, column 28): " + [ v.constructor.name ]);
  });
 ...
 */  
  var showPFC = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at OutilsJeu (line 35, column 1 - line 38, column 24): " + [ v.constructor.name ]);
  });
  var showMode = new Data_Show.Show(function (v) {
      if (v instanceof PFC) {
          return "PFC";
      };
      if (v instanceof PFCLS) {
          return "PFCLS";
      };
      if (v instanceof Poke) {
          return "Pokemon";
      };
      throw new Error("Failed pattern match at OutilsJeu (line 69, column 1 - line 72, column 30): " + [ v.constructor.name ]);
  });
  var showMaybeChoix = function (dictShow) {
      return function (v) {
          if (v instanceof Data_Maybe.Just) {
          ...
          throw new Error("Failed pattern match at OutilsJeu (line 54, column 1 - line 54, column 57): " + [ v.constructor.name ]);
      };
  };
  var showJoueur = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at OutilsJeu (line 59, column 1 - line 61, column 35): " + [ v.constructor.name ]);
  });
  var showVainqueur = function (v) {
      ...
      throw new Error("Failed pattern match at OutilsJeu (line 63, column 1 - line 63, column 40): " + [ v.constructor.name ]);
  };
 ...
 */  
  ...
  var combinaisons = function (v) {
      if (v instanceof PFC) {
          return [ reglesPFC(F.value)(P.value), reglesPFC(P.value)(C.value), reglesPFC(C.value)(F.value) ];
      };
      if (v instanceof PFCLS) {
          return [ reglesPFCLS(Pierre.value)(Ciseaux.value), reglesPFCLS(Pierre.value)(Lezard.value), reglesPFCLS(Feuille.value)(Pierre.value), reglesPFCLS(Feuille.value)(Spock.value), reglesPFCLS(Ciseaux.value)(Feuille.value), reglesPFCLS(Ciseaux.value)(Lezard.value), reglesPFCLS(Lezard.value)(Feuille.value), reglesPFCLS(Lezard.value)(Spock.value), reglesPFCLS(Spock.value)(Pierre.value), reglesPFCLS(Spock.value)(Ciseaux.value) ];
      };
      if (v instanceof Poke) {
          return [ reglesPoke(Bulbi.value)(Cara.value), reglesPoke(Cara.value)(Sala.value), reglesPoke(Sala.value)(Bulbi.value) ];
      };
      throw new Error("Failed pattern match at OutilsJeu (line 186, column 1 - line 186, column 37): " + [ v.constructor.name ]);
  };
  var associePoke = function (v) {
      if (v === 1) {
          return Bulbi.value;
      };
      if (v === 2) {
  ...
  exports["JoueurHumain"] = JoueurHumain;
  exports["Ordinateur"] = Ordinateur;
  exports["P"] = P;
  exports["F"] = F;
  exports["C"] = C;
  exports["Pierre"] = Pierre;
  exports["Feuille"] = Feuille;
  exports["Ciseaux"] = Ciseaux;
  exports["Lezard"] = Lezard;
  exports["Spock"] = Spock;
  exports["Bulbi"] = Bulbi;
  exports["Cara"] = Cara;
  exports["Sala"] = Sala;
  ...
  exports["PFCLS"] = PFCLS;
  exports["Poke"] = Poke;
  exports["showMaybeChoix"] = showMaybeChoix;
  exports["showVainqueur"] = showVainqueur;
  exports["combinaisons"] = combinaisons;
  exports["associePFC"] = associePFC;
  exports["associePFCLS"] = associePFCLS;
  exports["associePoke"] = associePoke;
  exports["showPFC"] = showPFC;
  exports["showPFCLS"] = showPFCLS;
  exports["showPoke"] = showPoke;
  exports["showMode"] = showMode;
  exports["eqPFC"] = eqPFC;
  exports["comparePFC"] = comparePFC;
  exports["eqPFCLS"] = eqPFCLS;
  exports["comparePFCLS"] = comparePFCLS;
  exports["eqPoke"] = eqPoke;
  exports["comparePoke"] = comparePoke;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  ...
  var Jeu = (function () {
      function Jeu(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Jeu.create = function (value0) {
          return function (value1) {
              return new Jeu(value0, value1);
          };
      };
      return Jeu;
  })();
  var PartiePFC = (function () {
      function PartiePFC(value0) {
          this.value0 = value0;
      };
      PartiePFC.create = function (value0) {
          return new PartiePFC(value0);
      };
      return PartiePFC;
  })();
  var PartiePFCLS = (function () {
      function PartiePFCLS(value0) {
          this.value0 = value0;
      };
      PartiePFCLS.create = function (value0) {
          return new PartiePFCLS(value0);
      };
      return PartiePFCLS;
  })();
  var PartiePoke = (function () {
      function PartiePoke(value0) {
          this.value0 = value0;
      };
      PartiePoke.create = function (value0) {
          return new PartiePoke(value0);
      };
      return PartiePoke;
  })();
  var vueDebut = function (mode) {
      return function (titre) {
          return function (sousTitre) {
              return function (image) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("divAlignee") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("ssTitreNiv1") ])([ Halogen_HTML_Core.text(titre) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("ssTitreNiv2") ])([ Halogen_HTML_Core.text(sousTitre) ]), Halogen_HTML_Elements.img([ Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(new DebuteJeu(mode)))), Halogen_HTML_Properties.src(image), Halogen_HTML_Properties.class_("image-zoom") ]) ]);
              };
          };
      };
  };
      ...
      return function (dictOrd) {
          return function (joueur) {
              return function (ordi) {
                  var $18 = Data_Eq.eq(dictEq)(joueur)(ordi);
                  if ($18) {
                      return Data_Maybe.Nothing.value;
                  };
                  var $19 = Data_Ord.lessThan(dictOrd)(joueur)(ordi);
                  if ($19) {
                      return new Data_Maybe.Just(OutilsJeu.Ordinateur.value);
                  };
                  return new Data_Maybe.Just(OutilsJeu.JoueurHumain.value);
              };
          };
      };
  };
  var updateChoix = function (dictBind) {
                      ...
                      return function (nombre) {
                          return function (mode) {
                              return function (a) {
                                  return function (fct) {
                                      return function (p) {
                                          return Control_Bind.bind(dictBind)(Effect_Class.liftEffect(dictMonadEffect)(Effect_Random.randomInt(1)(nombre)))(function (modeJeu) {
                                              return Control_Monad_State_Class.modify_(dictMonadState)(function (state) {
                                                  if (state.stage instanceof Jeu) {
                                                      var choixOrdiSelonLeMode = fct(modeJeu);
                                                      return {
                                                          stage: p({
                                                              choixJoueur: new Data_Maybe.Just(a),
                                                              choixOrdi: new Data_Maybe.Just(choixOrdiSelonLeMode),
                                                              vainqueur: vainqueur(dictEq)(dictOrd)(a)(choixOrdiSelonLeMode),
                                                              scoreJoueur: (function () {
                                                                  var v = vainqueur(dictEq)(dictOrd)(a)(choixOrdiSelonLeMode);
                                                                  if (v instanceof Data_Maybe.Just && v.value0 instanceof OutilsJeu.Ordinateur) {
                                                                      return state.stage.value1 - 1 | 0;
                                                                  };
                                                                  if (v instanceof Data_Maybe.Just && v.value0 instanceof OutilsJeu.JoueurHumain) {
                                                                      return state.stage.value1 + 1 | 0;
                                                                  };
                                                                  if (v instanceof Data_Maybe.Nothing) {
                                                                      return state.stage.value1;
                                                                  };
                                                                  throw new Error("Failed pattern match at Jeu2 (line 201, column 24 - line 204, column 41): " + [ v.constructor.name ]);
                                                              })()
                                                          })
                                                      };
                                                  };
      ...
      return function (v) {
          ...
          if (v instanceof NouvellePartie) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  if (state.stage instanceof PartiePFCLS) {
                      return {
                          stage: new Jeu(OutilsJeu.PFCLS.value, state.stage.value0.scoreJoueur)
                      };
                  };
                  if (state.stage instanceof PartiePFC) {
                      return {
                          stage: new Jeu(OutilsJeu.PFC.value, state.stage.value0.scoreJoueur)
                      };
                  };
                  if (state.stage instanceof PartiePoke) {
                      return {
                          stage: new Jeu(OutilsJeu.Poke.value, state.stage.value0.scoreJoueur)
                      };
                  };
                  return state;
              });
          ...
          if (v instanceof ChoixPFC) {
              return updateChoix(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Halogen_Query_HalogenM.monadStateHalogenM)(OutilsJeu.eqPFC)(OutilsJeu.comparePFC)(3)(OutilsJeu.PFC.value)(v.value0)(OutilsJeu.associePFC)(PartiePFC.create);
          };
          if (v instanceof ChoixPFCLS) {
              return updateChoix(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Halogen_Query_HalogenM.monadStateHalogenM)(OutilsJeu.eqPFCLS)(OutilsJeu.comparePFCLS)(5)(OutilsJeu.PFCLS.value)(v.value0)(OutilsJeu.associePFCLS)(PartiePFCLS.create);
          };
          if (v instanceof ChoixPoke) {
              return updateChoix(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Halogen_Query_HalogenM.monadStateHalogenM)(OutilsJeu.eqPoke)(OutilsJeu.comparePoke)(3)(OutilsJeu.Poke.value)(v.value0)(OutilsJeu.associePoke)(PartiePoke.create);
          };
          throw new Error("Failed pattern match at Jeu2 (line 105, column 1 - line 105, column 83): " + [ v.constructor.name ]);
      };
  };
  var showM = new Data_Show.Show(function (v) {
      if (v instanceof ChoixPFC) {
          return Data_Show.show(OutilsJeu.showPFC)(v.value0);
      };
      if (v instanceof ChoixPFCLS) {
          return Data_Show.show(OutilsJeu.showPFCLS)(v.value0);
      };
      if (v instanceof ChoixPoke) {
          return Data_Show.show(OutilsJeu.showPoke)(v.value0);
      };
      return "";
  });
  var renderNextButton = function (action) {
      return function (message) {
          return Halogen_HTML_Elements.button((function () {
              ...
              throw new Error("Failed pattern match at Jeu2 (line 100, column 5 - line 102, column 62): " + [ action.constructor.name ]);
          })())([ Halogen_HTML_Core.text(message) ]);
      };
  };
  var vuePartie = function (dictShow) {
      return function (mode) {
          return function (v) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("src/img/" + (Data_Show.show(OutilsJeu.showMode)(mode) + ("/" + (OutilsJeu.showMaybeChoix(dictShow)(v.choixJoueur) + ".jpg")))) ]), Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("src/img/" + (Data_Show.show(OutilsJeu.showMode)(mode) + ("/" + (OutilsJeu.showMaybeChoix(dictShow)(v.choixOrdi) + ".jpg")))) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Vainqueur : " + OutilsJeu.showVainqueur(v.vainqueur)) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Votre score actuel est de : " + (Data_Show.show(Data_Show.showInt)(v.scoreJoueur) + " point(s) ")) ]), Halogen_HTML_Elements.p_([ renderNextButton(new Data_Maybe.Just(NouvellePartie.value))("Nouvelle Partie") ]) ]);
          };
      };
  };
  var initialState = {
  ...
  var coupsPossibles = function (v) {
      if (v instanceof OutilsJeu.PFC) {
          return [ new ChoixPFC(OutilsJeu.P.value), new ChoixPFC(OutilsJeu.F.value), new ChoixPFC(OutilsJeu.C.value) ];
      };
      if (v instanceof OutilsJeu.PFCLS) {
          return [ new ChoixPFCLS(OutilsJeu.Pierre.value), new ChoixPFCLS(OutilsJeu.Feuille.value), new ChoixPFCLS(OutilsJeu.Ciseaux.value), new ChoixPFCLS(OutilsJeu.Lezard.value), new ChoixPFCLS(OutilsJeu.Spock.value) ];
      };
      if (v instanceof OutilsJeu.Poke) {
          return [ new ChoixPoke(OutilsJeu.Bulbi.value), new ChoixPoke(OutilsJeu.Sala.value), new ChoixPoke(OutilsJeu.Cara.value) ];
      };
      throw new Error("Failed pattern match at Jeu2 (line 46, column 1 - line 46, column 40): " + [ v.constructor.name ]);
  };
  var view = function (v) {
      if (v.stage instanceof ChoisirJeu) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Choisissez le mode") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("modesDeJeux") ])([ vueDebut(OutilsJeu.PFC.value)("Classique ")("Pierre feuille Ciseaux")("src/img/" + ("PFC" + ".jpg")), vueDebut(OutilsJeu.PFCLS.value)("Big Bang Theory")("Pierre Feuille Ciseaux Lezard Spock")("src/img/" + ("PFCLS" + ".jpg")), vueDebut(OutilsJeu.Poke.value)("Pokemon")("Eau,Plante,Feu")("src/img/" + ("poke" + ".jpg")) ]) ]);
      };
      if (v.stage instanceof Jeu) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_(Data_Functor.map(Data_Functor.functorArray)(function (choix) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("box") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Events.onClick(Data_Function["const"](new Data_Maybe.Just(choix))), Halogen_HTML_Properties.src("src/img/" + (Data_Show.show(OutilsJeu.showMode)(v.stage.value0) + ("/" + (Data_Show.show(showM)(choix) + ".jpg")))), Halogen_HTML_Properties.class_("image-zoom") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("texte") ])([ Halogen_HTML_Core.text(Data_Show.show(showM)(choix)) ]) ]);
          })(coupsPossibles(v.stage.value0))), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Votre score actuel est de : " + (Data_Show.show(Data_Show.showInt)(v.stage.value1) + " point(s) ")) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("survol") ])([ Halogen_HTML_Core.text("Rappel des Regles"), Halogen_HTML_Elements.br_, Halogen_HTML_Core.text("Survolez pour afficher"), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("affichageRegles") ])(Data_Functor.map(Data_Functor.functorArray)(function (r) {
              return Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(r) ]);
          })(OutilsJeu.combinaisons(v.stage.value0))) ]) ]);
      };
      if (v.stage instanceof PartiePFC) {
          return vuePartie(OutilsJeu.showPFC)(OutilsJeu.PFC.value)(v.stage.value0);
      };
      if (v.stage instanceof PartiePFCLS) {
          return vuePartie(OutilsJeu.showPFCLS)(OutilsJeu.PFCLS.value)(v.stage.value0);
      };
      if (v.stage instanceof PartiePoke) {
          return vuePartie(OutilsJeu.showPoke)(OutilsJeu.Poke.value)(v.stage.value0);
      };
      throw new Error("Failed pattern match at Jeu2 (line 54, column 1 - line 54, column 53): " + [ v.constructor.name ]);
  };
...
(function($PS) {
  ...
  var Jeu2 = $PS["Jeu2"];                
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(Halogen_VDom_Driver.runUI(Jeu2.page(Effect_Aff.monadEffectAff))(Data_Unit.unit)));
  exports["main"] = main;
})(PS);
PS["Main"].main();